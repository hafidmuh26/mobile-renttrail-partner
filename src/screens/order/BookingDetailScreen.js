...
import { rentById, save } from '../../actions/rents';
...
class BookingDetailScreen extends Component {
    ...
    onApproved() {
    this.props.save({...this.state, status: 'BORROWED'});
    }
    ...
    render() {
        ...
        return (
            <Container style={styles.container}>
                <CommonHeader navigation={navigation} title="Booking Details" />
                <Content>
